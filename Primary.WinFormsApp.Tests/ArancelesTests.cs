...
public class ArancelesTests : InstrumentTests
{
    ...
    public void CEDEARs_Calcular_DerechosMercado()
    {
        ...
        {
            var instrument = Argentina.Data.GetInstrumentDetailByTicker(cedear);
            _ = instrument.GetDerechosDeMercado().Should().Be(0.0847m / 100m, cedear);
        }
    }
