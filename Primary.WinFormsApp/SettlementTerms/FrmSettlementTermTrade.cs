...
public partial class FrmSettlementTermTrade : Form
{
    ...
    internal void Init(SettlementTermTrade trade)
    {
        ...
        Text = $"Venta {_trade.Sell.Instrument.InstrumentId.SymbolWithoutPrefix()} -> Compra {_trade.Buy.Instrument.InstrumentId.SymbolWithoutPrefix()}";
    ...
    {
        get => numCompraSize.ForeColor == AutoColor;
        set
        {
            if (value)
            {
    ...
    {
        get => numCompraPrice.ForeColor == AutoColor;
        set => numCompraPrice.ForeColor = value ? AutoColor : System.Drawing.SystemColors.WindowText;
    }

    public bool VentaPriceAutoUpdate
    {
        get => numVentaPrice.ForeColor == AutoColor;
        set => numVentaPrice.ForeColor = value ? AutoColor : System.Drawing.SystemColors.WindowText;
    }
