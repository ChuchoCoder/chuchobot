...
public partial class BidsOffersControl : UserControl
{
    ...
    private string CurrencyFormat => "N" + InstrumentDetail.InstrumentPricePrecision;
    private string CurrencySymbol => InstrumentDetail.IsPesos() ? "$" : InstrumentDetail.Currency;
